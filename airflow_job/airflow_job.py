...
with DAG(
    ...
    gcs_bucket = Variable.get("gcs_bucket", default_var="airflow-projects-giri")
    bq_project = Variable.get("bq_project", default_var="fifth-repeater-460020-t2")
    ...
    pyspark_task = DataprocCreateBatchOperator(
        ...
        batch=batch_details,
        batch_id=batch_id,
        project_id="fifth-repeater-460020-t2",
        region="us-central1",
